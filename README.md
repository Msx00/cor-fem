...
| Method   | [GMM-FEM(gpu)](https://github.com/siavashk/GMM-FEM) | [Adjoint-elastic](https://github.com/gmestdagh/adjoint-elastic-registration) | [BCF-FEM(gpu)](https://github.com/zixinyang9109/BCF-FEM) | COR-FEM (Ours) |
| -------- | ------: | --------------: | --------------------------------------------------: | -------------: |
